            ...
            for dirpath, filenames in files:    
                for file in filenames:
                    ...
                    if file.startswith('Norm'):
                        ...
                        match = re.search(r"S\d{3}|T\d{3}", file)
                    else:
                        match = re.search(r"Pan\d{2}", file)
                    ...
                    if (file.startswith('Norm') and not match in ['P29', 'P30', 'P31', 'P37', 'P38', 'P39', 'P45', 'P50', 'P25', 'P27', 'P52']) or \
                       (file.startswith('Lung') and not match in ['S002', 'S012', 'S017', 'S022', 'S023', 'S028', 'S031', 'T001', 'S034', 'S035', 'T002']) or \
                       (file.startswith('Pan') and not match in ['Pan01', 'Pan14', 'Pan16', 'Pan17', 'Pan22', 'Pan25', 'Pan42', 'Pan56', 'Pan29', 'Pan35', 'Pan49']):
