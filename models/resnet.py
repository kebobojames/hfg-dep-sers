...
class ResNet(nn.Module):
    def __init__(self, hidden_sizes, num_blocks, input_dim=1030,
    ...
    def change_final(self, new_class_num):
        self.linear = nn.Linear(self.z_dim, new_class_num)
...
if __name__ == "__main__":
    ...
    in_channels = 32
    cnn = ResNet(hidden_sizes, num_blocks, input_dim=1030, in_channels=in_channels, n_classes=3)
    y= cnn(torch.randn(1,1,1030))